   ...
   <header class="sticky top-0 z-40 backdrop-blur-md bg-gray-900/50 border-b border-cyan-800/30 shadow-2xl shadow-cyan-900/10">
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <!-- Mobile Menu Button -->
                <button id="nav-toggle" class="md:hidden p-2 rounded-lg text-cyan-400 border border-cyan-700 hover:bg-cyan-700/20 transition duration-200" aria-label="Toggle navigation" aria-expanded="false">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
                </button>
            </div>
            
            <!-- Mobile Navigation Menu -->
            <nav id="mobile-nav" class="md:hidden hidden border-t border-cyan-800/30 py-4">
                <div class="flex flex-col space-y-4">
                    <a href="/landing" class="text-gray-300 hover:text-cyan-400 font-medium transition duration-200 py-2 px-4 rounded-lg hover:bg-cyan-500/10">
                        Home
                    </a>
                    
                    <a href="/auth/login" class="text-cyan-400 border border-cyan-500 rounded-lg hover:bg-cyan-500/10 transition duration-200 py-2 px-4 text-center">
                        Login
                    </a>
                    
                    <a href="/auth/signup" class="bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-semibold rounded-lg shadow-xl py-2 px-4 text-center transition duration-300">
                        Get Started
                    </a>
                     ...
                     <a href="/ticket" class="bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-semibold rounded-lg shadow-xl py-2 px-4 text-center transition duration-300">
                        Tickets
                    </a>
                </div>
            </nav>
